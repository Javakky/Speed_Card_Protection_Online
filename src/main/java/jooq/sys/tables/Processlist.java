...
import jooq.sys.Sys;
import jooq.sys.enums.ProcesslistTrxAutocommit;
import jooq.sys.enums.ProcesslistTrxState;
import jooq.sys.tables.records.ProcesslistRecord;
import org.jooq.*;
...
public class Processlist extends TableImpl<ProcesslistRecord> {
    ...
    private static final long serialVersionUID = -1919109234;
     ...
     */
    public final TableField<ProcesslistRecord, ProcesslistTrxState> TRX_STATE = createField("trx_state", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(jooq.sys.enums.ProcesslistTrxState.class), this, "");

    /**
     * The column <code>sys.processlist.trx_autocommit</code>.
     */
    public final TableField<ProcesslistRecord, ProcesslistTrxAutocommit> TRX_AUTOCOMMIT = createField("trx_autocommit", org.jooq.impl.SQLDataType.VARCHAR(3).asEnumDataType(jooq.sys.enums.ProcesslistTrxAutocommit.class), this, "");
