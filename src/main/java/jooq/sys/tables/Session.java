...
import jooq.sys.Sys;
import jooq.sys.enums.SessionTrxAutocommit;
import jooq.sys.enums.SessionTrxState;
import jooq.sys.tables.records.SessionRecord;
...
public class Session extends TableImpl<SessionRecord> {
    ...
    private static final long serialVersionUID = -692302464;
     ...
     */
    public final TableField<SessionRecord, SessionTrxState> TRX_STATE = createField("trx_state", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(jooq.sys.enums.SessionTrxState.class), this, "");

    /**
     * The column <code>sys.session.trx_autocommit</code>.
     */
    public final TableField<SessionRecord, SessionTrxAutocommit> TRX_AUTOCOMMIT = createField("trx_autocommit", org.jooq.impl.SQLDataType.VARCHAR(3).asEnumDataType(jooq.sys.enums.SessionTrxAutocommit.class), this, "");
