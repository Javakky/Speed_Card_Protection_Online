...
public class Version extends TableImpl<VersionRecord> {
    ...
    private static final long serialVersionUID = 1584870029;
    /**
     ...
     */
    public final TableField<VersionRecord, String> MYSQL_VERSION = createField("mysql_version", org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
