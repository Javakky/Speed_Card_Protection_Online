...
import jooq.sys.Sys;
import jooq.sys.enums.X$sessionTrxAutocommit;
import jooq.sys.enums.X$sessionTrxState;
import jooq.sys.tables.records.X$sessionRecord;
...
public class X$session extends TableImpl<X$sessionRecord> {
    ...
    private static final long serialVersionUID = -1292900069;
     ...
     */
    public final TableField<X$sessionRecord, X$sessionTrxState> TRX_STATE = createField("trx_state", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(jooq.sys.enums.X$sessionTrxState.class), this, "");

    /**
     * The column <code>sys.x$session.trx_autocommit</code>.
     */
    public final TableField<X$sessionRecord, X$sessionTrxAutocommit> TRX_AUTOCOMMIT = createField("trx_autocommit", org.jooq.impl.SQLDataType.VARCHAR(3).asEnumDataType(jooq.sys.enums.X$sessionTrxAutocommit.class), this, "");
