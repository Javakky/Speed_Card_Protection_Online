...
import jooq.world.tables.records.CountrylanguageRecord;
...
public class Keys {
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<CityRecord, CountryRecord> CITY_IBFK_1 = Internal.createForeignKey(jooq.world.Keys.KEY_COUNTRY_PRIMARY, City.CITY, "city_ibfk_1", City.CITY.COUNTRYCODE);
        public static final ForeignKey<CountrylanguageRecord, CountryRecord> COUNTRYLANGUAGE_IBFK_1 = Internal.createForeignKey(jooq.world.Keys.KEY_COUNTRY_PRIMARY, Countrylanguage.COUNTRYLANGUAGE, "countryLanguage_ibfk_1", Countrylanguage.COUNTRYLANGUAGE.COUNTRYCODE);
    }
}
