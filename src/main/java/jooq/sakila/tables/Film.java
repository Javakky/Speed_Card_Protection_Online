...
public class Film extends TableImpl<FilmRecord> {
    ...
    private static final long serialVersionUID = 1855714256;
     ...
     */
    public final TableField<FilmRecord, FilmRating> RATING = createField("rating", org.jooq.impl.SQLDataType.VARCHAR(5).defaultValue(org.jooq.impl.DSL.inline("G", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(jooq.sakila.enums.FilmRating.class), this, "");
