...
import jooq.performance_schema.enums.PreparedStatementsInstancesOwnerObjectType;
import jooq.performance_schema.tables.records.PreparedStatementsInstancesRecord;
...
public class PreparedStatementsInstances extends TableImpl<PreparedStatementsInstancesRecord> {
    ...
    private static final long serialVersionUID = 1537905190;
     ...
     */
    public final TableField<PreparedStatementsInstancesRecord, PreparedStatementsInstancesOwnerObjectType> OWNER_OBJECT_TYPE = createField("OWNER_OBJECT_TYPE", org.jooq.impl.SQLDataType.VARCHAR(9).asEnumDataType(jooq.performance_schema.enums.PreparedStatementsInstancesOwnerObjectType.class), this, "");
