...
import jooq.performance_schema.enums.EventsStagesCurrentNestingEventType;
import jooq.performance_schema.tables.records.EventsStagesCurrentRecord;
...
public class EventsStagesCurrent extends TableImpl<EventsStagesCurrentRecord> {
    ...
    private static final long serialVersionUID = 1393066416;
     ...
     */
    public final TableField<EventsStagesCurrentRecord, EventsStagesCurrentNestingEventType> NESTING_EVENT_TYPE = createField("NESTING_EVENT_TYPE", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(jooq.performance_schema.enums.EventsStagesCurrentNestingEventType.class), this, "");
