...
import jooq.performance_schema.enums.HostCacheHostValidated;
import jooq.performance_schema.tables.records.HostCacheRecord;
...
public class HostCache extends TableImpl<HostCacheRecord> {
    ...
    private static final long serialVersionUID = 2071716647;
     ...
     */
    public final TableField<HostCacheRecord, HostCacheHostValidated> HOST_VALIDATED = createField("HOST_VALIDATED", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(jooq.performance_schema.enums.HostCacheHostValidated.class), this, "");
