...
import jooq.performance_schema.enums.SetupInstrumentsEnabled;
import jooq.performance_schema.enums.SetupInstrumentsTimed;
import jooq.performance_schema.tables.records.SetupInstrumentsRecord;
...
public class SetupInstruments extends TableImpl<SetupInstrumentsRecord> {
    ...
    private static final long serialVersionUID = -1373721784;
     ...
     */
    public final TableField<SetupInstrumentsRecord, SetupInstrumentsEnabled> ENABLED = createField("ENABLED", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(jooq.performance_schema.enums.SetupInstrumentsEnabled.class), this, "");

    /**
     * The column <code>performance_schema.setup_instruments.TIMED</code>.
     */
    public final TableField<SetupInstrumentsRecord, SetupInstrumentsTimed> TIMED = createField("TIMED", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(jooq.performance_schema.enums.SetupInstrumentsTimed.class), this, "");
