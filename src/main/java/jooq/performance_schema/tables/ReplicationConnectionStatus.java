...
import jooq.performance_schema.enums.ReplicationConnectionStatusServiceState;
import jooq.performance_schema.tables.records.ReplicationConnectionStatusRecord;
...
public class ReplicationConnectionStatus extends TableImpl<ReplicationConnectionStatusRecord> {
    ...
    private static final long serialVersionUID = -2020535873;
     ...
     */
    public final TableField<ReplicationConnectionStatusRecord, ReplicationConnectionStatusServiceState> SERVICE_STATE = createField("SERVICE_STATE", org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false).asEnumDataType(jooq.performance_schema.enums.ReplicationConnectionStatusServiceState.class), this, "");
