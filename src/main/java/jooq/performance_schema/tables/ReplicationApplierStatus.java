...
import jooq.performance_schema.enums.ReplicationApplierStatusServiceState;
import jooq.performance_schema.tables.records.ReplicationApplierStatusRecord;
...
public class ReplicationApplierStatus extends TableImpl<ReplicationApplierStatusRecord> {
    ...
    private static final long serialVersionUID = 1574716848;
     ...
     */
    public final TableField<ReplicationApplierStatusRecord, ReplicationApplierStatusServiceState> SERVICE_STATE = createField("SERVICE_STATE", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(jooq.performance_schema.enums.ReplicationApplierStatusServiceState.class), this, "");
