...
import jooq.performance_schema.tables.records.ThreadsRecord;
...
public class Threads extends TableImpl<ThreadsRecord> {
    ...
    private static final long serialVersionUID = 632596895;
     ...
     */
    public final TableField<ThreadsRecord, ThreadsInstrumented> INSTRUMENTED = createField("INSTRUMENTED", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(jooq.performance_schema.enums.ThreadsInstrumented.class), this, "");

    /**
     * The column <code>performance_schema.threads.HISTORY</code>.
     */
    public final TableField<ThreadsRecord, ThreadsHistory> HISTORY = createField("HISTORY", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(jooq.performance_schema.enums.ThreadsHistory.class), this, "");
