...
import jooq.performance_schema.enums.EventsTransactionsCurrentAccessMode;
import jooq.performance_schema.enums.EventsTransactionsCurrentAutocommit;
import jooq.performance_schema.enums.EventsTransactionsCurrentNestingEventType;
import jooq.performance_schema.enums.EventsTransactionsCurrentState;
import jooq.performance_schema.tables.records.EventsTransactionsCurrentRecord;
...
public class EventsTransactionsCurrent extends TableImpl<EventsTransactionsCurrentRecord> {
    ...
    private static final long serialVersionUID = -296848488;
     ...
     */
    public final TableField<EventsTransactionsCurrentRecord, EventsTransactionsCurrentState> STATE = createField("STATE", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(jooq.performance_schema.enums.EventsTransactionsCurrentState.class), this, "");
     ...
     */
    public final TableField<EventsTransactionsCurrentRecord, EventsTransactionsCurrentAccessMode> ACCESS_MODE = createField("ACCESS_MODE", org.jooq.impl.SQLDataType.VARCHAR(10).asEnumDataType(jooq.performance_schema.enums.EventsTransactionsCurrentAccessMode.class), this, "");
     ...
     */
    public final TableField<EventsTransactionsCurrentRecord, EventsTransactionsCurrentAutocommit> AUTOCOMMIT = createField("AUTOCOMMIT", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(jooq.performance_schema.enums.EventsTransactionsCurrentAutocommit.class), this, "");
     ...
     */
    public final TableField<EventsTransactionsCurrentRecord, EventsTransactionsCurrentNestingEventType> NESTING_EVENT_TYPE = createField("NESTING_EVENT_TYPE", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(jooq.performance_schema.enums.EventsTransactionsCurrentNestingEventType.class), this, "");
