...
import jooq.performance_schema.enums.SetupObjectsEnabled;
import jooq.performance_schema.enums.SetupObjectsObjectType;
import jooq.performance_schema.enums.SetupObjectsTimed;
import jooq.performance_schema.tables.records.SetupObjectsRecord;
import org.jooq.*;
...
public class SetupObjects extends TableImpl<SetupObjectsRecord> {
    ...
    private static final long serialVersionUID = 1289597267;
     ...
     */
    public final TableField<SetupObjectsRecord, SetupObjectsEnabled> ENABLED = createField("ENABLED", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).defaultValue(org.jooq.impl.DSL.inline("YES", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(jooq.performance_schema.enums.SetupObjectsEnabled.class), this, "");

    /**
     * The column <code>performance_schema.setup_objects.TIMED</code>.
     */
    public final TableField<SetupObjectsRecord, SetupObjectsTimed> TIMED = createField("TIMED", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).defaultValue(org.jooq.impl.DSL.inline("YES", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(jooq.performance_schema.enums.SetupObjectsTimed.class), this, "");
