...
import jooq.performance_schema.enums.SetupActorsEnabled;
import jooq.performance_schema.enums.SetupActorsHistory;
import jooq.performance_schema.tables.records.SetupActorsRecord;
...
public class SetupActors extends TableImpl<SetupActorsRecord> {
    ...
    private static final long serialVersionUID = 1869758601;
     ...
     */
    public final TableField<SetupActorsRecord, SetupActorsEnabled> ENABLED = createField("ENABLED", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).defaultValue(org.jooq.impl.DSL.inline("YES", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(jooq.performance_schema.enums.SetupActorsEnabled.class), this, "");

    /**
     * The column <code>performance_schema.setup_actors.HISTORY</code>.
     */
    public final TableField<SetupActorsRecord, SetupActorsHistory> HISTORY = createField("HISTORY", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).defaultValue(org.jooq.impl.DSL.inline("YES", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(jooq.performance_schema.enums.SetupActorsHistory.class), this, "");
