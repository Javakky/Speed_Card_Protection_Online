...
import jooq.performance_schema.enums.SocketInstancesState;
import jooq.performance_schema.tables.records.SocketInstancesRecord;
...
public class SocketInstances extends TableImpl<SocketInstancesRecord> {
    ...
    private static final long serialVersionUID = 1582999865;
     ...
     */
    public final TableField<SocketInstancesRecord, SocketInstancesState> STATE = createField("STATE", org.jooq.impl.SQLDataType.VARCHAR(6).nullable(false).asEnumDataType(jooq.performance_schema.enums.SocketInstancesState.class), this, "");
