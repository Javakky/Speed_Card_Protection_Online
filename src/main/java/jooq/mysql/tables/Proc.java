...
import jooq.mysql.enums.ProcIsDeterministic;
import jooq.mysql.enums.ProcLanguage;
import jooq.mysql.enums.ProcSecurityType;
import jooq.mysql.enums.ProcSqlDataAccess;
import jooq.mysql.enums.ProcType;
import jooq.mysql.tables.records.ProcRecord;
...
public class Proc extends TableImpl<ProcRecord> {
    ...
    private static final long serialVersionUID = -1862473276;
     ...
     */
    public final TableField<ProcRecord, ProcType> TYPE = createField("type", org.jooq.impl.SQLDataType.VARCHAR(9).nullable(false).asEnumDataType(jooq.mysql.enums.ProcType.class), this, "");
     ...
     */
    public final TableField<ProcRecord, ProcLanguage> LANGUAGE = createField("language", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).defaultValue(org.jooq.impl.DSL.inline("SQL", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(jooq.mysql.enums.ProcLanguage.class), this, "");

    /**
     * The column <code>mysql.proc.sql_data_access</code>.
     */
    public final TableField<ProcRecord, ProcSqlDataAccess> SQL_DATA_ACCESS = createField("sql_data_access", org.jooq.impl.SQLDataType.VARCHAR(17).nullable(false).defaultValue(org.jooq.impl.DSL.inline("CONTAINS_SQL", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(jooq.mysql.enums.ProcSqlDataAccess.class), this, "");

    /**
     * The column <code>mysql.proc.is_deterministic</code>.
     */
    public final TableField<ProcRecord, ProcIsDeterministic> IS_DETERMINISTIC = createField("is_deterministic", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).defaultValue(org.jooq.impl.DSL.inline("NO", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(jooq.mysql.enums.ProcIsDeterministic.class), this, "");

    /**
     * The column <code>mysql.proc.security_type</code>.
     */
    public final TableField<ProcRecord, ProcSecurityType> SECURITY_TYPE = createField("security_type", org.jooq.impl.SQLDataType.VARCHAR(7).nullable(false).defaultValue(org.jooq.impl.DSL.inline("DEFINER", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(jooq.mysql.enums.ProcSecurityType.class), this, "");
