...
import jooq.mysql.enums.FuncType;
...
public class Func extends TableImpl<FuncRecord> {
    ...
    private static final long serialVersionUID = -1265838479;
     ...
     */
    public final TableField<FuncRecord, FuncType> TYPE = createField("type", org.jooq.impl.SQLDataType.VARCHAR(9).nullable(false).asEnumDataType(jooq.mysql.enums.FuncType.class), this, "");
