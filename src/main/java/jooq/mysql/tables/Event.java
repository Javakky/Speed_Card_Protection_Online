...
import jooq.mysql.enums.EventIntervalField;
import jooq.mysql.enums.EventOnCompletion;
import jooq.mysql.enums.EventStatus;
...
public class Event extends TableImpl<EventRecord> {
    ...
    private static final long serialVersionUID = 1382011149;
     ...
     */
    public final TableField<EventRecord, EventIntervalField> INTERVAL_FIELD = createField("interval_field", org.jooq.impl.SQLDataType.VARCHAR(18).asEnumDataType(jooq.mysql.enums.EventIntervalField.class), this, "");
     ...
     */
    public final TableField<EventRecord, EventStatus> STATUS = createField("status", org.jooq.impl.SQLDataType.VARCHAR(18).nullable(false).defaultValue(org.jooq.impl.DSL.inline("ENABLED", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(jooq.mysql.enums.EventStatus.class), this, "");

    /**
     * The column <code>mysql.event.on_completion</code>.
     */
    public final TableField<EventRecord, EventOnCompletion> ON_COMPLETION = createField("on_completion", org.jooq.impl.SQLDataType.VARCHAR(8).nullable(false).defaultValue(org.jooq.impl.DSL.inline("DROP", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(jooq.mysql.enums.EventOnCompletion.class), this, "");
