...
import jooq.mysql.tables.records.ColumnsPrivRecord;
import jooq.mysql.tables.records.DbRecord;
import jooq.mysql.tables.records.EngineCostRecord;
import jooq.mysql.tables.records.EventRecord;
import jooq.mysql.tables.records.FuncRecord;
import jooq.mysql.tables.records.GtidExecutedRecord;
import jooq.mysql.tables.records.HelpCategoryRecord;
import jooq.mysql.tables.records.HelpKeywordRecord;
import jooq.mysql.tables.records.HelpRelationRecord;
import jooq.mysql.tables.records.HelpTopicRecord;
import jooq.mysql.tables.records.InnodbIndexStatsRecord;
import jooq.mysql.tables.records.InnodbTableStatsRecord;
import jooq.mysql.tables.records.NdbBinlogIndexRecord;
import jooq.mysql.tables.records.PluginRecord;
import jooq.mysql.tables.records.ProcRecord;
import jooq.mysql.tables.records.ProcsPrivRecord;
import jooq.mysql.tables.records.ProxiesPrivRecord;
import jooq.mysql.tables.records.ServerCostRecord;
import jooq.mysql.tables.records.ServersRecord;
import jooq.mysql.tables.records.SlaveMasterInfoRecord;
import jooq.mysql.tables.records.SlaveRelayLogInfoRecord;
import jooq.mysql.tables.records.SlaveWorkerInfoRecord;
import jooq.mysql.tables.records.TablesPrivRecord;
import jooq.mysql.tables.records.TimeZoneLeapSecondRecord;
import jooq.mysql.tables.records.TimeZoneNameRecord;
import jooq.mysql.tables.records.TimeZoneRecord;
import jooq.mysql.tables.records.TimeZoneTransitionRecord;
import jooq.mysql.tables.records.TimeZoneTransitionTypeRecord;
